...
class ImprovedSystemTrayManager:
    ...
    def create_icon_image(self) -> Optional[Image.Image]:
        ...
        try:
            ...
            draw.rectangle(
                [
                    book_x + shadow_offset,
                    book_y + shadow_offset,
                    book_x + book_width + shadow_offset,
                    book_y + book_height + shadow_offset,
                ],
                fill=(0, 0, 0, 60),
            )
            ...
            page_margin = 12
            page_area = [
                book_x + spine_width + page_margin,
                book_y + page_margin,
                book_x + book_width - page_margin,
                book_y + book_height - page_margin,
            ]
