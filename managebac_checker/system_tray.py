...
class SystemTrayManager:
    ...
    def create_icon_image(self) -> Image.Image:
        ...
        draw.rectangle([book_left, book_top, book_right, book_bottom], 
                      fill=(255, 255, 255, 255), outline=(44, 62, 80, 255), width=2)
        
        # Book pages
        draw.rectangle([book_left + 4, book_top + 4, book_right - 4, book_bottom - 4], 
...
class NotificationManager:
    ...
    def notify_report_generated(self, report_path: str):
        ...
        message = f"Report saved to {report_path}" if self.language == 'en' else f"报告已保存到{report_path}"
        self.send_notification(title, message)
