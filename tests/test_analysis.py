...
class TestAssignmentAnalyzer(unittest.TestCase):
    ...
    def test_course_extraction(self):
        ...
        self.assertEqual(
            self.analyzer._extract_course_name(ap_title),
    ...
    def test_urgency_calculation(self):
        ...
        self.assertEqual(
            self.analyzer._calculate_urgency(urgent_assignment, now), "urgent"
        )
        ...
        self.assertEqual(
            self.analyzer._calculate_urgency(later_assignment, now), "later"
        )
