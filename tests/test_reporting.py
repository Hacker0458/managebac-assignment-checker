...
class TestReportGenerator(unittest.TestCase):
    ...
    def test_markdown_report_generation(self):
        ...
        # 设置配置以包含markdown格式
        self.config.report_format = ["markdown"]
        reports = self.reporter.generate_reports(assignments, analysis)
    ...
    def test_priority_calculation(self):
        ...
        analyzer = AssignmentAnalyzer(self.config)
        
        # 高优先级
        high_priority = {"title": "Final Exam", "status": "Pending"}
        self.assertEqual(analyzer._calculate_priority(high_priority), "high")

        # 中优先级
        medium_priority = {"title": "Math Homework", "status": "Pending"}
        self.assertEqual(analyzer._calculate_priority(medium_priority), "medium")

        # 低优先级
        low_priority = {"title": "Reading Task", "status": "Pending"}
        self.assertEqual(analyzer._calculate_priority(low_priority), "low")
