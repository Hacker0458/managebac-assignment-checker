...
// MARK: - Web抓取服务
@MainActor
public final class WebScrapingService: NSObject, ObservableObject, Sendable {
    ...
    /// 登录ManageBac
    public func login(email: String, password: String, schoolURL: String) async -> Bool {
    ...
    /// 获取作业数据
    public func fetchAssignments(schoolURL: String) async -> [Assignment] {
...
// MARK: - WebView导航代理
public final class WebViewNavigationDelegate: NSObject, WKNavigationDelegate, Sendable {
