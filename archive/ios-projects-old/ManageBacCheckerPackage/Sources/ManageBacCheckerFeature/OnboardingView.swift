...
public struct OnboardingPage {
    ...
    public init(title: String, subtitle: String, imageName: String, primaryColor: Color) {
        self.title = title
...
@MainActor
public struct AccountConfigurationView: View {
    @EnvironmentObject private var assignmentManager: AssignmentManager
    ...
    private func testConnection() {
        ...
        // 更新配置
        assignmentManager.config.schoolURL = schoolURL
        ...
        // 模拟连接测试
        Task {
            try? await Task.sleep(nanoseconds: 1_000_000_000) // 1秒延迟，提高响应速度
            await MainActor.run {
